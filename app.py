...
EMAIL_I18N = {
    'de': {
        ...
        'p_plan_y':  'Jahres-Abo',
        'p_plan_m':  'Monats-Abo',
        'p_features': '✅ Fertige Vorlagen für Carport, Pergola &amp; Co.<br>✅ Vollständig werbefrei<br>✅ PDF-, DXF- &amp; CNC-Export<br>✅ Säge-Tool, Schnittplan &amp; Kalkulation',
    ...
    'en': {
        ...
        'p_features': '✅ Ready-made templates for carport, pergola &amp; more<br>✅ Completely ad-free<br>✅ PDF, DXF &amp; CNC export<br>✅ Saw tool, cutting plan &amp; costing',
...
LANDING_TXT = {
    'de': {
        ...
        'f3_p': 'Carport, Pergola, Gartenhaus oder Terrassendach: einfach Maße eingeben und die komplette Konstruktion wird automatisch erzeugt — durchgerechnet statt hingestellt. Pfetten liegen auf den Stützen, Sparren sitzen mit einer Kerve auf, Ecken sind verblattet, Kopfbänder steifen aus. Kein Bauteil steckt im anderen.',
        ...
        'f10_p': 'Auflager, Überblattung sowie Schlitz und Zapfen als echte Geometrie — nicht angedeutet, sondern zugeschnitten. Ein Bauteil markieren genügt: es wird an alles angepasst, was es berührt, und nur es selbst wird eingeschnitten.',
    ...
    'en': {
        ...
        'f3_p': 'Carport, pergola, garden shed or patio roof: just enter the dimensions and the complete structure is generated automatically — worked out, not just placed. Purlins rest on the posts, rafters are birdsmouthed onto them, corners are half-lapped, knee braces stiffen the frame. No part sits inside another.',
        ...
        'f10_t': 'Timber joints',
        'f10_p': 'Bearing notch, halved lap and mortise-and-tenon as real geometry — actually cut, not just hinted at. Select a single part: it is fitted to everything it touches, and only it gets cut.',
    ...
    'fr': {
        ...
        'f3_p': 'Carport, pergola, abri de jardin ou toit de terrasse : saisissez vos dimensions et la construction complète est générée automatiquement — calculée, pas simplement posée. Les pannes reposent sur les poteaux, les chevrons sont entaillés dessus, les angles sont mi-bois, les aisseliers contreventent. Aucune pièce ne traverse une autre.',
        ...
        'f10_p': "Appui entaillé, mi-bois et tenon-mortaise en géométrie réelle — vraiment découpés, pas seulement suggérés. Sélectionne une seule pièce : elle s'ajuste à tout ce qu'elle touche, et elle seule est entaillée.",
...
UPSELL_I18N = {
    'de': {
        ...
        'b1t': 'Fertige Vorlagen nach Maß', 'b1d': 'Carport, Pergola, Gartenhaus, Terrassendach',

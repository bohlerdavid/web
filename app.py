...
LANDING_TXT = {
    'de': {
        ...
        'f3_p': 'Carport, Pergola, Gartenhaus oder Terrassendach: einfach Maße eingeben und die komplette Konstruktion wird automatisch erzeugt — durchgerechnet statt hingestellt. Pfetten liegen auf den Stützen, Sparren sitzen mit einer Kerve auf, Ecken sind verblattet, Kopfbänder steifen aus. Kein Bauteil steckt im anderen. Die Pergola kannst du ohne Abo erzeugen.',
    ...
    'fr': {
        ...
        'f3_p': 'Carport, pergola, abri de jardin ou toit de terrasse : saisissez vos dimensions et la construction complète est générée automatiquement — calculée, pas simplement posée. Les pannes reposent sur les poteaux, les chevrons sont entaillés dessus, les angles sont mi-bois, les aisseliers contreventent. Aucune pièce ne traverse une autre. La pergola est gratuite, sans abonnement.',

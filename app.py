...
LANDING_TXT = {
    'de': {
        ...
        'f3_p': 'Carport, Pergola, Gartenhaus oder Terrassendach: einfach Maße eingeben und die komplette Konstruktion wird automatisch erzeugt.',
        ...
        'pr_lead': 'Starte kostenlos und upgrade jederzeit. Monatlich kündbar, keine Bindung.',
        'pr_free_desc': 'Mit Werbung · Ideal zum Ausprobieren',
        'pr_free_f1': '✓ 3D Visualisierung',
        'pr_free_f2': '✓ Bis zu 3 Projekte',
        'pr_free_f3': '✓ Stückliste als CSV',
        'pr_free_f4': '⚠ Mit Werbebannern',
        'pr_free_f5': '✗ PDF Export',
        'pr_free_f6': '✗ Gruppen & Ebenen',
        'pr_free_cta': 'Kostenlos starten',
        'pr_mon_desc': 'Werbefrei · Alle Features entsperrt',
    ...
    'en': {
        ...
        'f3_p': 'Carport, pergola, garden shed or patio roof: just enter the dimensions and the complete structure is generated automatically.',
        ...
        'pr_lead': 'Start for free and upgrade any time. Cancel any month, no lock-in.',
        'pr_free_desc': 'With ads · Ideal for trying it out',
        'pr_free_f1': '✓ 3D visualization',
        'pr_free_f2': '✓ Up to 3 projects',
        'pr_free_f3': '✓ Parts list as CSV',
        'pr_free_f4': '⚠ With ad banners',
        'pr_free_f5': '✗ PDF export',
        'pr_free_f6': '✗ Groups & layers',
        'pr_free_cta': 'Start for free',
        'pr_mon_desc': 'Ad-free · All features unlocked',
    ...
    'fr': {
        ...
        'f3_p': 'Carport, pergola, abri de jardin ou toit de terrasse : saisissez vos dimensions et la construction complète est générée automatiquement.',
        ...
        'pr_lead': 'Commencez gratuitement et passez à Premium quand vous le souhaitez. Résiliable chaque mois, sans engagement.',
        'pr_free_desc': 'Avec publicité · Idéal pour essayer',
        'pr_free_f1': '✓ Visualisation 3D',
        'pr_free_f2': "✓ Jusqu'à 3 projets",
        'pr_free_f3': '✓ Liste de pièces en CSV',
        'pr_free_f4': '⚠ Avec bannières publicitaires',
        'pr_free_f5': '✗ Export PDF',
        'pr_free_f6': '✗ Groupes & calques',
        'pr_free_cta': 'Démarrer gratuitement',
        'pr_mon_desc': 'Sans publicité · Toutes les fonctionnalités débloquées',
...
UPSELL_I18N = {
    'de': {
        ...
        'b1t': 'Unbegrenzte Projekte &amp; Balken', 'b1d': 'keine Limits mehr',
    ...
    'en': {
        ...
        'b1t': 'Unlimited projects &amp; beams',   'b1d': 'no more limits',
    ...
    'fr': {
        ...
        'b1t': 'Projets &amp; poutres illimités',  'b1d': 'plus aucune limite',
